<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden lg:flex ml-10 self-center">
                    <x-search-box />
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('trainees.index')" :active="request()->routeIs('trainees.*')">Trainees</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('trainers.index')" :active="request()->routeIs('trainers.*')">Trainers</x-responsive-nav-link>
        </div>
